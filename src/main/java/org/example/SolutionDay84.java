...
//Time complexity is O(nlogn), space complexity is O(logn), where n is number of tokens
...
//There is no need to play token0, since you cannot play it face-up to add to your score. The maximum score achievable
// is 1.
//Example 3:
