...
//    medium. #implementation #random. Task require O(1) time complexity for all operations. Tricky moments - get random value
//    initially it is not possible in map and set; removing elements from list by value is not O(1), so you need to find
//    a way to remove by index. Removing element from list by index has O(1) time complexity
...
public class SolutionDay37Second {
    private Map<Integer, Integer> map;
    private List<Integer> list;
    private Random random;

    public SolutionDay37Second() {
