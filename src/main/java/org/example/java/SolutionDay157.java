...
//    Output: -1
//    Explanation: We need 3 bouquets each has 2 flowers, that means we need 6 flowers. We only have 5 flowers so it
//    is impossible to get the needed bouquets and we return -1.
//    Example 3:
...
public class SolutionDay157 {
    public static int minDays(int[] bloomDay, int m, int k) {
        int n = bloomDay.length;
        long flowers = (long) k * m;
